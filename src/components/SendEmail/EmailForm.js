            ...
            >
                ...
                <Modal.Body>
                    <form onSubmit={sendEmail} >
                        <Row>
                            <Col lg="4"> <input type="email" placeholder="email" name="email" className="form-control" value={email} onChange={handleOnEmail} /></Col>
                            <Col lg="6"> <input type="text" placeholder="url" name="message" className="form-control" /></Col>
                            <Col lg="2"> <input type="submit" value="Send" className="form-control btn" onClick={handleSubmit} /></Col>
                        </Row>
                    </form>
                </Modal.Body>
            </Modal>
